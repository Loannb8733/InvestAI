...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "assets_portfolio_id_fkey", "assets", "portfolios", ["portfolio_id"], ["id"], ondelete="CASCADE"
    )

    # --- transactions.asset_id -> CASCADE
    op.drop_constraint("transactions_asset_id_fkey", "transactions", type_="foreignkey")
    op.create_foreign_key(
        "transactions_asset_id_fkey", "transactions", "assets", ["asset_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "calendar_events_user_id_fkey", "calendar_events", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "portfolio_snapshots_user_id_fkey", "portfolio_snapshots", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
