...
from app.services.smart_insights_analyzers import SmartInsightAnalyzersMixin
from app.services.smart_insights_types import (  # noqa: F401 — re-exported
    AnomalyImpact,
    InsightCategory,
    InsightSeverity,
...
class SmartInsightsService(SmartInsightAnalyzersMixin):
