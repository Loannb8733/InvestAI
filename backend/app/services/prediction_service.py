...
from app.services.prediction_alpha import PredictionAlphaMixin
...
class PredictionService(PredictionAlphaMixin, PredictionCyclesMixin, PredictionMetricsMixin):
